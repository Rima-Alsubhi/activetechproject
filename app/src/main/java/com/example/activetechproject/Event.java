...
public class Event {
    ...
    public String getThe_organization() { return The_organization; }
    public void setThe_organization(String the_organization) { this.The_organization = the_organization; }
